export const LOGO_ANIMATION_DURATION_SECS = 0.7;
export const DESCRIPTION_ANIMATION_DURATION_SECS = 0.6;
export const FOOTER_ANIMATION_DURATION_SECS = 0.8;
export const SLEEP_BEFORE_CHIPS_SECS =
  LOGO_ANIMATION_DURATION_SECS + DESCRIPTION_ANIMATION_DURATION_SECS + FOOTER_ANIMATION_DURATION_SECS + 0.9;
...
export const CONTENT_PADDING_FROM_WALLS = 24;
